...
class MovieDbProvider extends \Faker\Provider\Base
{
    ...
    protected static $jobs = [
        ...
        [
            'name' => 'Directeur de postproduction',
            'department' => 'Production',
        ],
        [
        ...
        [
            'name' => 'Mixeur',
            'department' => 'Soundtrack',
        ],
        [
            'name' => 'Musicien de film',
            'department' => 'Soundtrack',
        ],
        [
            'name' => 'Perchman',
    ...
    {
        return self::$movies[array_rand(self::$movies)];
    }

    /**
     * Retourne un job au hasard
     */
    public static function movieJob()
    {
        // On peut ici bénéficié de la méthode static randomElement de faker
        // pour obtenir une valeur aléatoire
        return self::randomElement(self::$jobs);
    }

    /**
     * Retourne un departments au hasard
     */
    public static function movieDepartment()
    {
        // On peut ici bénéficié de la méthode static randomElement de faker
        // pour obtenir une valeur aléatoire 
     ...
     * Retourne un rôle
     * 
     * Ne fonctionne pas en static dans ce cas
     */
